...
Public Class Form1
    ...
    Private Sub LoadToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LoadToolStripMenuItem.Click
        ...
        While RDR.Read
            ...
            C.tel = Convert.ToString(IIf(RDR.IsDBNull(RDR.GetOrdinal("tel")), "", RDR.Item("tel")))
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim dbName As String = "p7g1"

        Dim usernamevar As String = "p7g1"
        Dim userPass As String = "Jacm2100+"

        CN = New SqlConnection("Data Source = " + dbServer + " ;" + "Initial Catalog = " + dbName + "; uid = " + usernamevar + ";" + "password = " + userPass)
        CMD = New SqlCommand
        CMD.Connection = CN
    ...
    Private Sub SubmitContact(ByVal C As Contact)
        CMD.CommandText = "INSERT Customers (CustomerID, CompanyName, ContactName, Address, " &
                          "City, Region, PostalCode, Country, tel, FAX) " &
